...
export interface Model {
    scene_select(scene_file: string): Promise<DidHandleMessage>
    resize(width: number, height: number): Promise<DidHandleMessage>
...
export class CpuModel implements Model {
    ...
    private state: CpuModelState.State
...
namespace CpuModelState {
    ...
    abstract class AbstractState implements State {
        ...
        async scene_select(scene_file: string): Promise<DidHandleMessage> {
            console.log(`CpuModel<${this.state_name()}>: Didn't handle scene_select(${scene_file})`)
